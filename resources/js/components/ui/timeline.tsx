...
export const Timeline = () => {
  ...
  return (
    <div
    className="w-full flex flex-col justify-center items-center  font-sans md:px-10"
    ref={containerRef}
  >
          ...
          <div key={index} className="flex justify-start pt-5 ">
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <div className="hidden md:block text-base md:pl-20">
                ...
                <p>{new Date(item.updated_at).toLocaleTimeString("en-US")}</p>
              </div>
            </div>
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              ...
              <div>
                <p>
                  ...
                  {item.model_data.evaluation_criteria}
                </p>
                <div className="flex gap-2">
                  <p className="font-medium">Score:</p>
                  <p>{item.changes.before?.score}</p>
                  <p>
                    <MoveRight />
                  </p>
                  <p>{item.changes.after?.score}</p>
                </div>
              </div>
            </div>
          </div>
