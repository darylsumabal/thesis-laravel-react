...
export const ScoreTableTeam = ({ data }: { data: TeamParticipantScore[] }) => {
    ...
    return (
        <div className="w-full">
            <h2 className="mb-2 p-4 text-center text-2xl font-bold">Candidates</h2>
